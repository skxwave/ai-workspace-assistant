...
Revision ID: ccf17a2f8339
Revises:
Create Date: 2026-08-04 15:02:44.108053
...
def upgrade() -> None:
    ...
    op.drop_index(
        op.f("checkpoint_blobs_thread_id_idx"), table_name="checkpoint_blobs"
    )
